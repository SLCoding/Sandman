...
Check if Plex had any connections or streams in a configurable time
	...
	def configure():
		...
		configurable.append(["plexcheck", "logfile", '/var/lib/plexmediaserver/Library/Application Support/Plex Media Server/Logs/Plex Media Server.log', "Plex Logfile to analyse"])
